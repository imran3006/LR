...
class User{
  private $db;
   ...
   public function userRegistration($data)
   {
    ...
    if (filter_var($email, FILTER_VALITATE_EMAIL) === false) {
    ...
    if ($result) {
      $msg = "<div class ='alert alert-success'><strong>Error !</strong>Thank you</div>";
      return $msg;

    }else {
      $msg = "<div class ='alert alert-danger'><strong>Error !</strong>The sorry</div>";
      return $msg;
    }
